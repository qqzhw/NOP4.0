...
namespace Hcdz.PcieLib54
{
    /* PCI diagnostics plug-and-play and power management events handler *
     * function type */
    public delegate void USER_EVENT_CALLBACK(ref WD_EVENT pEvent, PCIE_Device000 dev);
    /* PCI diagnostics interrupt handler function type */
    public delegate void USER_INTERRUPT_CALLBACK(PCIE_Device000 device);


    public partial class PCIE_Device000
    {
        ...
        internal protected PCIE_Device000(WD_PCI_SLOT slot) : this(0, 0, slot) { }

        internal protected PCIE_Device000(DWORD dwVendorId, DWORD dwDeviceId,
            WD_PCI_SLOT slot)
        {
   ...
   (
       ...
       int lpOverlapped
        ...
        private void PC1220X64_IntHandler(PCIE_Device000 device)
        {
